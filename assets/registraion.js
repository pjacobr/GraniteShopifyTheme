console.log("loading validation function");
function validateCustomerRegistration() {
  ...
  const FirstName = document.getElementById("create_customer-FirstName")
    .innerText;
  const LastName = document.getElementById("create_customer-LastName")
    .innerText;
  ...
  const password = document.getElementById("create_customer-password")
    .innerText;
  ...
  xhr.open(
    "POST",
    "https://ec2-3-86-45-122.compute-1.amazonaws.com/register_customer",
    true
  );
